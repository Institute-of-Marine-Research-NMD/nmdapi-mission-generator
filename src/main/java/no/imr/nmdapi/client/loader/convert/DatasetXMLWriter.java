...
//        MissionType mission = new MissionType();
      ...
      //  cruise.setd.setDatapath(rs.getString("datapath"));
        ...
        //Platform info
        Map<String,TypeValue> platformMap = platformCodeDAO.getCruisePlatformCodes(missionID);
      ...
      if (platformPath.equals("NOPLATFORMCODES")){
             String altPlatformPath = createPlatformURICode( platformCodeDAO.getCruisePlatformAfterStart(missionID));
       ...
       //First write cruise xml
          ...
          cruiseDatatype.setUrl("Whats here");
